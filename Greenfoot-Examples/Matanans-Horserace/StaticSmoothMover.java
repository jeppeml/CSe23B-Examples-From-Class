 ...
 * @version 3.0
 */
public abstract class StaticSmoothMover extends Actor
{
    ...
    public void moveTowards(int x, int y, double distance)
    {
        double radians = Math.atan2(exactY-(double)y, exactX-(double)x);
        double dx = Math.cos(radians) * distance;
        double dy = Math.sin(radians) * distance;
        setLocation(exactX - dx, exactY - dy);
    }
